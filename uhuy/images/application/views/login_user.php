...
<head>
    ...
    <link href="<?php echo base_url(); ?>uhuy/css/css.css" rel="stylesheet">
</head>
...
<body class="login-page">
    ...
    <div class="card1">
        ...
        <div class="row" style="margin-bottom:0 !important;padding-top:0 !important;">
            ...
            <div class="col-md-8">
                <div class="logo">
                    ...
                    <small>Tempat Informasi<br>SMK TELKOM MALANG</small>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="body">
                <form action="<?php base_url();?>do_login" method="post" entype="multipart/form-data">
                    ...
                    <p class="notif">(Untuk melakukan login di web, diharap siswa telah melakukan login di aplikasi)</p>
                    <div class="row">
