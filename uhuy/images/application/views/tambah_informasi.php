        ...
        <div class="content-top ">
            <div class="container ">
                ...
                <div class="row content">
                    <div class="col-sm-12">
                      <form class="form-horizontal" method="post" id="form-pendaftaran" enctype="multipart/form-data" action="<?php echo base_url();?>index.php/admin/insert_info"> 
                          <div class="box-body">
...
<!--                                             <div id="floating-panel">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/admin/tambah_informasi" class="btn btn-md btn-primary">
                            Refresh</a>
                            <a href="<?php echo base_url(); ?>index.php/admin/informasi" class="btn btn-md btn-warning">Kembali</a>
                          </div>
                          <!-- /.box-body -->
                        </form>
                    </div>
