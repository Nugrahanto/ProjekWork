...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 class="redbg"><a href="<?php echo base_url(); ?>index.php/admin/home">TEL Board</a><span style="font-size: 9pt;">INFORMASI <a href="www.smktelkom-mlg.sch.id">SMK TELKOM MALANG</a></span></a></h1>
			</div>
			<!-- <div class="head-t">
				<ul class="card">
				...
				<div class="nav-top ">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav white">
							<li class=""><a href="<?php echo base_url(); ?>index.php/admin/home" class="hyper "><span>Home</span></a></li>	
											...
											<ul class="multi-column-dropdown">
											 <?php
								                    foreach ($jenis as $data) {
								                        echo '
												<li><a href="'.base_url().'index.php/admin/'.$data->nama_jenis.'"><i class="fa fa-angle-right" aria-hidden="true"></i>'.$data->nama_jenis.'</a></li>
															';
						                    		}
						                    ?>
											</ul>
							...
							<li class=""><a href="<?php echo base_url(); ?>index.php/admin/near_event" class="hyper "><span>Acara Terdekat</span></a></li>
						</ul>
					</div>
					</nav>
					<div class="cart" >
					<p><?php echo $this->session->userdata('nama_akun')?> | <a href="<?php echo base_url(); ?>index.php/admin/logout"><span class="fa fa-sign-out my-cart-icon"></span></a></p>
					</div>
					<div class="clearfix"></div>
				</div>
