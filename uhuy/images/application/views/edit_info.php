                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-8 col-lg-8">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" id="tanggal" name="tanggal" autofocus class="form-control" value="<?php $tgl = date("d-m-Y", strtotime($detail_info->tanggal));
                                                    echo $tgl; ?>" style="padding-left: 2%;"/>
                                                </div>
                                            </div>
                                            <div class="input-group">
