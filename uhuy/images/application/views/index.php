                                    ...
                                    <tbody>
                                        ...
                                        foreach ($all as $data) {
                                            echo '
                                                <tr class="odd gradeX">
                                                    <td>'.$no.'</td>
                                                    <td><a href="'.base_url().'index.php/admin/detail_informasi/'.$data->id_informasi.'"><img src="'.base_url().'uploads/'.$data->foto.'" style="width:50%; text-align:center; margin: 0px auto; border:2px solid black"></a></td>
