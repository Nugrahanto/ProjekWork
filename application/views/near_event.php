...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 class="redbg"><a href="<?php echo base_url(); ?>user/home">TEL Board</a><span style="font-size: 9pt;">INFORMASI <a href="www.smktelkom-mlg.sch.id">SMK TELKOM MALANG</a></span></a></h1>
			</div>
			<!-- <div class="head-t">
				<ul class="card">
				...
				<div class="nav-top ">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav white">
							...
							<li class="active"><a href="<?php echo base_url(); ?>user/near_event" class="hyper "><span>Acara Terdekat</span></a></li>
						</ul>
					</div>
					</nav>
					<div class="cart" >
						<p><?php echo $this->session->userdata('nama_akun')?> | <a href="<?php echo base_url(); ?>user/logout"><span class="fa fa-sign-out my-cart-icon"></span></a></p>
					</div>
					<div class="clearfix"></div>
				</div>
				...
				<div class=" con-w3l">
						...
						<?php
							foreach ($near as $data) {
								...
								echo '
							<div class="col-md-3 m-wthree height" style="margin-top:2%;">
